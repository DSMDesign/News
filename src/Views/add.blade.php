                ...
                <form method="post" action="{{ route('admin.article.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="input-field">
                                <input id="title" name="title" type="text" value="{{ old('title') }}" class="" minlength="3" required="required" aria-required="true" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="input-field">
                                <textarea id="news" name="news" class="wysiwyg" required="required" aria-required="true">{{ old('news') }}</textarea>
                            </div>
                            <div class="input-field">
                                <button type="submit" data-imsg="Adding Article." class="btn btn-success submit">Add</button>
                            </div>
                        </div>
                    </div>
                </form>
